              ...
              <div className="px-6 pt-10 pb-2">
                ...
                <div className="space-y-2 text-gray-700 pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    {/* {isAvailable ? <p>In Stock</p> : <p>Out 0f Stock</p>} */}
                  </div>
                  <Divider />
                  <p>{description}</p>
                </div>
                ...
                <div className="px-6 py-4 flex justify-end gap-4 ">
                  <button
                    ...
                    type="button"
                    className="px-4 py-2 text-sm font-semibold text-slate-900 hover:text-slate-800 hover:border-slate-800 rounded-md"
                  >
                    Cancel
                  </button>
                </div>
