  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 ">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
       ...
       Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui dolorem eum neque praesentium rerum nulla placeat asperiores necessitatibus. Perspiciatis, officia iusto delectus nostrum ducimus sapiente repudiandae consectetur necessitatibus voluptates! Consequatur, tenetur quaerat? Nisi eum quod praesentium beatae cupiditate aliquam, blanditiis nam asperiores nihil sequi doloremque, voluptatum voluptas eius consectetur inventore!
          </p>
        </div>
        <div className="w-full md:w-1/2 mb-6 md-6 md:mb-0">
          <img
